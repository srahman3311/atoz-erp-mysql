...
export const subheadReducer = (state, action) => {
    ...
    switch(action.type) {
        ...
        case FETCH_DATA:
            ...
            return {
                ...state,
                subheads: action.payload.subheads,
        ...
        case TOGGLE_DELETE_MODAL: 
            return {
                ...state,
                subheadID: action.subheadID,
                displaySubheadDeleteModal: state.displaySubheadDeleteModal ? false : true, 
                actionListId: 0
            }
